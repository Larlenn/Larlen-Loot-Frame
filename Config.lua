...
Config.DEFAULTS = {
    ...
    maxNameLength        = 32,
    maxNameLengthPerFeed = false,
    fontSizeOffset       = 0,
    fontSizePerFeed      = false,
    fontFamilyPerFeed    = false,
    fontOutline          = "",
    fontOutlinePerFeed   = false,
    ilvlColorPerFeed      = false,
    tertiaryColor        = nil,
    tertiaryColorPerFeed  = false,
    socketColor          = nil,
